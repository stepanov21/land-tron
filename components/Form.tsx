...
const Form = () => {
  return (
    <form className='flex sm:flex-col sm:gap-4 py-10 px-24 card-gradient rounded-[18px] border border-purple mt-10 lg:px-8'>
        ...
        <Button className='mr-[30px]'>Registration</Button>
        <Button className='bg-transparent border border-accent text-white'>Leave contact</Button>
    </form>
  )
}
